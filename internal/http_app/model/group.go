...
type Group struct {
	...
	OwnerMemberId   uint   `gorm:"column:owner_member_id;type:int(11);NOT NULL" json:"owner_member_id"`               // 所属者会员ID
	FounderMemberId uint   `gorm:"column:founder_member_id;type:int(11);default:0;NOT NULL" json:"founder_member_id"` // 创始人ID
